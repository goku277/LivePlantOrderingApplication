...
import com.simi.plantorderingapp.Adapter.CategoricalDataAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String s: split) {
            if (!s.trim().isEmpty()) {
                ...
                System.out.println("From categorical Data fetchData: " + fetchData);
            }
        }
        ...
        categoricalDataAdapter = new CategoricalDataAdapter(save1, name, mobile, fetchData.get(6), CategoricalData.this);
