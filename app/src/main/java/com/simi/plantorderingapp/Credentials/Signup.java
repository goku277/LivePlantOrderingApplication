package com.simi.plantorderingapp.Credentials;
...
import com.simi.plantorderingapp.Components.Admin;
...
public class Signup extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadData() {
        ...
        pf.insertData(name.getText().toString().trim(), phone.getText().toString().trim(), "");
