...
public class SummerAdapter extends RecyclerView.Adapter<SummerAdapter.ViewHolder> {
    ...
    ArrayList<SaveSummerPlantsData> save= new ArrayList<>();
    Set<Set<String>> setOfSets= new LinkedHashSet<>();
    Context context;
    ArrayList<String> detailsList= new ArrayList<>();

    public SummerAdapter(Context context, ArrayList<SaveSummerPlantsData> save, Set<Set<String>> setOfSets) {
        this.save = save;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.summer_horizontal_layout, parent, false);
    ...
    private void doWork(Set<String> set1, String url) {
        ...
        System.out.println("From SummerAdapter doWork() is: " + detailsList);
        ...
        System.out.println("From SummerAdapter val1: " + val1);
        ...
        System.out.println("From SummerAdapter details: " + details);
  ...
  /*  private void doWork(Set<String> set1) {
        detailsList.addAll(set1);
        System.out.println("From SummerAdapter doWork() is: " + detailsList);

        Intent sendData= new Intent(context, CollapsingToolbar.class);
        sendData.putStringArrayListExtra("details", detailsList);
        context.startActivity(sendData);
    }    */
